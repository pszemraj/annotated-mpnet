...
- Add `--flex-backend {auto,triton,triton_decode,flash}` CLI override for RoPE+FlexAttention runs
- Persist/restore `flex_backend` in architecture config for checkpoint consistency
- Document RoPE + FlexAttention backend behavior and options in docs
